...
export default function Home() {
  ...
  // دالة ذكية للتعامل مع أخطاء تحميل الصور
  const handleImageError = (e, productId) => {
    const currentSrc = e.target.src;
    
    // المحاولة 1: إذا كان الرابط ينتهي بـ .png، جرب .PNG (لحل مشكلة حساسية الأحرف في Git)
    if (currentSrc.endsWith('.png')) {
      e.target.src = currentSrc.replace('.png', '.PNG');
    } 
    // المحاولة 2: إذا كان .PNG، جرب مسارات بديلة
    else if (currentSrc.endsWith('.PNG')) {
      e.target.src = `/public/product-${productId}.PNG`;
    }
    // المحاولة 3: خطة أخيرة - صور احترافية من Unsplash لضمان عدم كسر التصميم
    else {
      ...
      e.target.src = fallbackImages[(productId - 1) % fallbackImages.length];
    }
  };
    ...
    <main className="main-content">
      ...
      <div className={`preloader ${isLoaded ? 'hidden' : ''}`}>
        <div className="preloader-content">
          <img src="/logo.png" alt="Sugar Moon" className="preloader-logo" onError={(e) => handleImageError(e, 0)} />
      ...
      <nav className="navbar" id="navbar">
        <div className="nav-container">
          <a href="#home" className="nav-logo">
            <img src="/logo.png" alt="Logo" className="nav-logo-icon" onError={(e) => handleImageError(e, 0)} />
        ...
        <div className="footer-container">
          <div className="footer-top">
            <div className="footer-brand">
              <img src="/logo.png" alt="Logo" className="footer-logo" onError={(e) => handleImageError(e, 0)} />
